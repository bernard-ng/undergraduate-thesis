...
\begin{list}{}{En dehors de l'introduction, la partie conclusive et l'annexe, ce travail est organisé en trois chapitres comme suit:}
    ...
    % \item \textbf{\textsl{\texttt{Chapitre 2}}}  Ce chapitre présentera une analyse du système juridique en République Démocratique du Congo, en abordant les lois, les principes fondamentaux, les procédures et les défis spécifiques à la numérisation et à l'accès aux informations juridiques. Cette base permettra de souligner l'importance et la nécessité de développer des outils technologiques adaptés pour rendre le Droit plus accessible.
